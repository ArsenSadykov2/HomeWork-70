            ...
            <main>
                ...
                <Modal show={showModal} title="Информация о контакте" onClose={closeModal}>
                    <div className="modal-body">
                        {selectedContact && (
                            <>
                                <img src={selectedContact.image ? selectedContact.image : imageUrl} alt={selectedContact.name} className="img-fluid mb-3"/>
                                <hr/>
                    ...
                    <div className="d-flex justify-content-end gap-2 mt-3">
                        ...
                        {/*    <Link to="/edit-contacts/:idContact" className="btn btn-success">Edit</Link>*/}
                        {/*</button>*/}
                    </div>
                </Modal>
            </main>
